...
@lang ru
#plugin Отобразить текст актера 
#desc
...
#range-desc Если расстояние от актёра до центра камеры находится в пределах видимости, отобразится текст.
#textAttr Текстовый атрибут
#textAttr-desc Строка: Текстовое содержимое, отобразить рядом с Актером.
#template Текстовый шаблон
#template-desc Замените <content> на прочитанный текст при рендеринге текста, если не требуется можно оставить пустую строку.
#offsetY Смещение Y
